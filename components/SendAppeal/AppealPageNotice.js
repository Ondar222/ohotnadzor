    ...
    return (
        <div className="font-mono [&>p]:py-1">
            <p>Просим Вас внимательно ознакомиться с порядком приема и рассмотрения обращений,
                направленных в адрес Государственного комитета по охране объектов животного мира Республики Тыва.</p>
            <p>Обращения, поступившие в адрес Государственного комитета по охране объектов животного мира Республики Тыва,
            ...
            <p>Вы можете направить обращение в Государственный комитет по охране объектов животного мира Республики Тыва:</p>
            <p>- путем заполнения соответствующей формы, размещенной на официальном сайте</p>
            <p>- путём его направления на почтовый или электронный адрес Государственного комитета по охране объектов животного мира Республики Тыва</p>
            <p>- путем звонка по телефону приемной Государственного комитета по охране объектов животного мира Республики Тыва</p>

            <p>1. Обращения, направленные в форме электронного документа через официальный сайт, поступают на
                рассмотрение в Государственный комитет по охране объектов животного мира Республики Тыва и рассматриваются
                работниками
                Государственного комитета по охране объектов животного мира Республики Тыва.</p>
